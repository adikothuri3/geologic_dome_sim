"""Generate a full-body-collision G1 from Playground's MJX G1, using Menagerie mesh extents.
    ...
    python sims/mujoco/scripts/make_full_collision_xml.py [--out sims/mujoco/xmls/g1_full_collision.xml]
...
def detect_resting_overlaps(body_xml: pathlib.Path):
    ...
    scene_src = MJ / "xmls" / "scene_g1_full_collision.xml"
...
def main() -> None:
    ...
    ap.add_argument("--out", default=str(MJ / "xmls" / "g1_full_collision.xml"))
    args = ap.parse_args()
    ...
    header = (
        "<!--\n"
        "  GENERATED by sims/mujoco/scripts/make_full_collision_xml.py -- do not hand-edit.\n"
        "  Regenerate after any Playground update, then re-run sims/mujoco/scripts/check_full_collision.py.\n"
        "\n"
